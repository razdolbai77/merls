...
- [ ] Make unbraced Merlin expressions evaluate left-to-right in `src/asm/expression.ts`, then add `{...}` algebraic precedence; cover the documented `1+2*3 = 9` and `{1+2*3} = 7` cases.
