...
The current Visual Studio Code extension also sets the language-scoped defaults `editor.tabSize = 8` and `editor.indentSize = 8` for files using the `6502` language, and it actively reapplies `tabSize = 8` to visible `6502` editors at runtime.
