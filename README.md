...
- Addressing diagnostics select direct-page or absolute modes from resolvable operand values; `STA $00,Y` is rejected unless absolute syntax is explicitly forced.
