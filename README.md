...
- The `test/fixtures/invalid/` directory and `examples/DIAGNOSTICS.S` contain negative samples covering 17 of 21 diagnostic codes (including forward macro/equate calls, macro arity mismatch, recursion, unclosed macros, unterminated loops, and invalid operands); the showcase and fixture tests assert the exact expected diagnostic-code sequence for every invalid fixture.
