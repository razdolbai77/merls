...
export const opcodeDefinitions: readonly OpcodeDefinition[] = [
  ...
  defineOpcode("bge", ["relative"], "Alias for Branch if Carry Set"),
  defineOpcode("bit", ["zeroPage", "absolute"], "Bit Test"),
  defineOpcode("blt", ["relative"], "Alias for Branch if Carry Clear"),
...
export const directiveDefinitions: readonly DirectiveDefinition[] = [
  ...
  defineDirective("lup", "assembler", true, "Begin a repeat region."),
  defineDirective("pmc", "assembler", true, "Invoke a macro by name."),
  ...
  defineDirective("--^", "assembler", true, "End a repeat region."),
  defineDirective(">>>", "assembler", true, "Invoke a macro by name."),
